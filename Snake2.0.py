#This Program trains the AI to Learn The Game and Master It
...
class SnakeGameAI:
    ...
    def _update_ui(self):
        ...
        for pt in self.snake:
            ...
            pygame.draw.rect(self.display, RED, pygame.Rect(pt.x+7, pt.y+7, 6, 6))
            
        pygame.draw.rect(self.display, BLUE2, pygame.Rect(self.food.x, self.food.y, BLOCK_SIZE, BLOCK_SIZE))
        
        text = font.render("SNAKE by ASHISH MOTWANI \n Score: " + str(self.score), True, BLACK)
        self.display.blit(text, [0, 0])
        pygame.display.flip()
        
    def _move(self, action):
        #straight or left or rgiht directions
